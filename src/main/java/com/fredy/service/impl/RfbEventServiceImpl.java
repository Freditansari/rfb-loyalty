...
public class RfbEventServiceImpl implements RfbEventService {
    ...
    public void delete(Long id) {
        ...
        rfbEventSearchRepository.delete(id);
    }
    ...
    public Page<RfbEventDTO> search(String query, Pageable pageable) {
        ...
        Page<RfbEvent> result = rfbEventSearchRepository.search(queryStringQuery(query), pageable);
        return result.map(rfbEventMapper::toDto);
    }
}
