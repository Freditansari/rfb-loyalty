...
public class RfbEventAttendanceResourceIntTest {
    ...
    @Autowired
    private RfbEventAttendanceSearchRepository rfbEventAttendanceSearchRepository;
    ...
    public void initTest() {
        rfbEventAttendanceSearchRepository.deleteAll();
    ...
    public void createRfbEventAttendance() throws Exception {
        ...
        RfbEventAttendance rfbEventAttendanceEs = rfbEventAttendanceSearchRepository.findOne(testRfbEventAttendance.getId());
        assertThat(rfbEventAttendanceEs).isEqualToIgnoringGivenFields(testRfbEventAttendance);
    }
    ...
    public void deleteRfbEventAttendance() throws Exception {
        ...
        boolean rfbEventAttendanceExistsInEs = rfbEventAttendanceSearchRepository.exists(rfbEventAttendance.getId());
        assertThat(rfbEventAttendanceExistsInEs).isFalse();
