...
import com.fredy.service.RfbEventService;
import com.fredy.repository.search.RfbEventSearchRepository;
import com.fredy.service.dto.RfbEventDTO;
import com.fredy.service.mapper.RfbEventMapper;
...
public class RfbEventResourceIntTest {
    ...
    @Autowired
    private RfbEventSearchRepository rfbEventSearchRepository;
    ...
    public void initTest() {
        rfbEventSearchRepository.deleteAll();
    ...
    public void createRfbEvent() throws Exception {
        ...
        RfbEvent rfbEventEs = rfbEventSearchRepository.findOne(testRfbEvent.getId());
        assertThat(rfbEventEs).isEqualToIgnoringGivenFields(testRfbEvent);
    }
    ...
    public void deleteRfbEvent() throws Exception {
        ...
        boolean rfbEventExistsInEs = rfbEventSearchRepository.exists(rfbEvent.getId());
        assertThat(rfbEventExistsInEs).isFalse();
