...
public class RfbLocationResourceIntTest {
    ...
    @Autowired
    private RfbLocationSearchRepository rfbLocationSearchRepository;
    ...
    public void initTest() {
        rfbLocationSearchRepository.deleteAll();
    ...
    public void createRfbLocation() throws Exception {
        ...
        RfbLocation rfbLocationEs = rfbLocationSearchRepository.findOne(testRfbLocation.getId());
        assertThat(rfbLocationEs).isEqualToIgnoringGivenFields(testRfbLocation);
    }
    ...
    public void deleteRfbLocation() throws Exception {
        ...
        boolean rfbLocationExistsInEs = rfbLocationSearchRepository.exists(rfbLocation.getId());
        assertThat(rfbLocationExistsInEs).isFalse();
