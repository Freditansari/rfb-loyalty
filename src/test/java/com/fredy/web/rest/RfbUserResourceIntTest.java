...
import com.fredy.RfbLoyaltyApp;

import com.fredy.domain.RfbUser;
import com.fredy.repository.RfbUserRepository;
import com.fredy.service.RfbUserService;
import com.fredy.repository.search.RfbUserSearchRepository;
import com.fredy.service.dto.RfbUserDTO;
import com.fredy.service.mapper.RfbUserMapper;
...
public class RfbUserResourceIntTest {
    ...
    @Autowired
    private RfbUserSearchRepository rfbUserSearchRepository;
    ...
    public void initTest() {
        rfbUserSearchRepository.deleteAll();
    ...
    public void createRfbUser() throws Exception {
        ...
        RfbUser rfbUserEs = rfbUserSearchRepository.findOne(testRfbUser.getId());
        assertThat(rfbUserEs).isEqualToIgnoringGivenFields(testRfbUser);
    }
    ...
    public void deleteRfbUser() throws Exception {
        ...
        boolean rfbUserExistsInEs = rfbUserSearchRepository.exists(rfbUser.getId());
        assertThat(rfbUserExistsInEs).isFalse();
